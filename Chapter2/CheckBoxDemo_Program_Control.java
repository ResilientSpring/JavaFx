...
public class CheckBoxDemo_Program_Control extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// Specify the handler for the event generated by the control, i.e. resetButton in this case. 
		resetButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				responseLabel.setText("All options cleared.");
		...
		selectAllButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				touchScreenCheckBox.setSelected(true);
				
				responseLabel.setText("All options are selected.");
		...
		pane.getChildren().addAll(headingLabel, keyboardCheckBox, mouseCheckBox, touchScreenCheckBox, responseLabel,
				selectedLabel, resetButton, selectAllButton);
